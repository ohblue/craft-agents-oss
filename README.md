...
[Check out how I just connected to Slack →](https://agents.craft.do/s/DRNQEiy8w2e1v5LPgKl8b) · [Or watch it set up Gmail in one go →](https://agents.craft.do/s/yUVFb8zrlFaaGuw7mjoke)
